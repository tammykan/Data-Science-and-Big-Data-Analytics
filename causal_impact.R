...
# Read data
sum_usd_data <- read.csv("sum_usd.csv", header = F, na.strings = c('NA',''))
stock_price_data <- read.csv("aal_stock_price_data.csv", header = F, na.strings = c('NA'), stringsAsFactors = FALSE)
